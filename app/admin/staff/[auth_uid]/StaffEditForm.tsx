          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <a
                ...
                className="md:hidden flex items-center gap-1 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white text-xs font-medium px-2.5 py-1 rounded-full transition-colors"
              >
